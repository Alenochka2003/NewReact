...
function App() {
  const citiesData = [
    ...
    {
      name: "Киото",
      description: "Город на острове Хонсю, известный своими многочисленными классическими буддийскими храмами, а также садами, императорскими дворцами.",
  ...
  return (
    <div className="App">
      <CitySelector cities={citiesData} onSelectCity={setSelectedCityIndex} />
      <CityCard city={citiesData[selectedCityIndex]} />
    </div>
  );
}
